...
class QualityAudit(Node):
    ...
    def generate_audit_report(self) -> Dict[str, Any]:
        ...
        audit_report['executive_summary'] = {
            ...
            'critical_issues': audit_details.get(
                'findings_summary',
...
class ContinuousImprovement(Node):
    ...
    def generate_improvement_report(self) -> Dict[str, Any]:
        ...
        improvement_report['executive_summary'] = {
            ...
            'active_projects': improvement_results.get(
                'cycle_overview',
                {}).get('projects_active',
                0),
            'opportunities_pursued': len(self.prioritized_improvements),
            'performance_trend': 'improving' if performance_data.get(
                'improvement_impact',
                0) > 0.1 else 'stable',
