...
class CentralityAnalysis:
    ...
    def get_top_nodes(self, metric_type: NetworkMetricType, top_n: int = 5) -> List[Tuple[uuid.UUID, float]]:
...
class SFMDigraph(Node):
    ...
    def find_shortest_path(self, source_id: uuid.UUID, target_id: uuid.UUID) -> Optional[PathAnalysis]:
